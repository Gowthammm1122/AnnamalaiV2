        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          ...
          >
            ...
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-4">
                <h3 className="text-3xl font-display text-dark tracking-tight leading-tight">
                  Shaping the future elite <span className="italic font-serif text-primary">public and civil service sectors.</span>
                </h3>
                <p className="text-gray-500 font-light text-sm sm:text-base leading-relaxed">
              ...
              <div className="space-y-5 pt-4 border-t border-gray-150/50">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-xs font-bold text-dark uppercase tracking-wider">LEARN • EXCEL • ACHIEVE • SERVE</h4>
                    <p className="text-gray-500 text-xs font-light leading-relaxed">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="space-y-1">
                    <h4 className="text-xs font-bold text-dark uppercase tracking-wider">Democratized Success Hub</h4>
                    <p className="text-gray-500 text-xs font-light leading-relaxed">
